...
public interface RemoteServeur extends java.rmi.Remote
{
  ...
  /**
   * Ajoute dans la liste du serveur, que le client <b>client</b> possède le
   * fichier <b>fichier</b> avec les attributs <b>attr</b>.
   *
  ...
  /**
   * Retire dans le liste du serveur le fichier <b>fichier</b> pour le client
   * <b>client</b>.
   *
  ...
  /**
   * Retire de la liste du serveur TOUS les fichiers partagés par le client
   * <b>client</b>.
   *
  ...
  /**
   * Recherche une liste de fichier repondant à l'expression réguliere
   * <b>regexp</b>.
   *
   * @param regexp l'expression régulière pour matcher les fichiers.
   * @return la liste des nom de fichiers correspondant a l'expression
   *   régulière.
   * @throws RemoteException
   */
  ...
  /**
   * Met à jour les attributs <b>attr</b> du fichier aynt pour identifiant
   * <b>idFichier</b> du client <b>client</b>.
   *
